<footer class="bg-black py-12 px-6 mt-20 border-t border-gray-800">
    <div class="container mx-auto">
        <div class="grid md:grid-cols-4 gap-8">
            <!-- About -->
            <div>
                <h3 class="text-lg font-bold text-primary mb-4">CineWave</h3>
                <p class="text-gray-400 text-sm">Your ultimate streaming destination for movies and TV shows.</p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-400">
                    ...
                    <li><a href="{{ route('support') }}" class="hover:text-primary transition">Support</a></li>
                </ul>
            </div>
